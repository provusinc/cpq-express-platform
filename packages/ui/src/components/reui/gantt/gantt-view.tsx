// @ts-nocheck -- vendored ReUI code, not written for noUncheckedIndexedAccess (see AGENTS.md)
"use client"
...
import { GanttBar } from "@workspace/ui/components/reui/gantt/gantt-bar"
import {
  ...
  wasRecentDrag,
} from "@workspace/ui/components/reui/gantt/gantt-dnd"
import {
  buildDependencyPath,
  getBaselineVariance,
  getDayKey,
  ...
  zonedStartOfDay,
  type GanttLaneMemo,
} from "@workspace/ui/components/reui/gantt/gantt-lib"
import type {
  GanttBaseline,
